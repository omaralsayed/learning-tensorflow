...
#
# The loss function measures this and then gives the data to the optimizer which
...
#
# We're asking the model to figure out how to fit the X values to the Y values.
...
#
# Return using the predict method
